                ...
                <div className='hidden md:grid grid-cols-3  gap-4 py-10 pt-20'>
                    <div className='flex items-center text-2xl text-center'>
                        ...
                        <p className='flex justify-center items-center pl-4'>
                            <a className='px-3 text-2xl' href="#"><FaFacebook/></a>
                            <a className='px-3 text-2xl' href="#"><FaTwitter/></a>
                            <a className='px-3 text-2xl' href="#"><FaGooglePlus/></a>
                        </p>
                    </div>
                ...
                <div className='md:grid grid-cols-3 py-24'>
                    <div className='flex justify-center items-center text-center pb-10 md:pb-0  md:border-r'>
                        <div>
                            ...
                            <h2 className='text-3xl font-semibold pb-3'>Address</h2>
                            <p className='text-xl'>Uttara-1208, Dhaka</p>
                    ...
                    <div className='flex justify-center items-center text-center py-10 md:py-0 border-y md:border-y-0 md:border-r'>
                        <div>
                            ...
                            <h2 className='text-3xl font-semibold pb-3 text-yellow-500'>Open Timing</h2>
                            <p className='text-xl'>Saturday - Friday</p>
                            <p className='text-xl'>8 am - 10 pm</p>
                        </div>
                    </div>
                    <div className='flex justify-center items-center text-center pt-10 md:pt-0 '>
                        <div >
                            ...
                            <h2 className='text-3xl font-semibold pb-3'>Contact Us</h2>
                            <p className='text-xl'>Email: food-point@food.com</p>
                            <p className='text-xl'><a href="tel:00987564">Tel: 00987564</a></p>
