            ...
            <div className='mx-10 md:mx-20 lg:mx-60'>
                <div className='flex justify-between items-center py-6'>
                    ...
                    <div className='text-white hidden md:flex justify-between items-center text-lg font-semibold'>
                        <div>
                            <ul className='flex'>
                                <li className='pl-5'><a className='pb-3 hover:border-b-2 hover:text-lime-500' href="#">Home</a></li>
                                <li className='pl-5'><a className='pb-3 hover:border-b-2 hover:text-lime-500' href="#">About</a></li>
